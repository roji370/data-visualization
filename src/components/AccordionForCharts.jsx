        ...
        <div>
            <Accordion>
                <Accordion.Item eventKey="0">
                    <Accordion.Header>Polar Area and Doughnut Charts </Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header>Bar Chart</Accordion.Header>
                    <Accordion.Body>
                        <BarChart serverData={data} />
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                    <Accordion.Header>Line Chart</Accordion.Header>
                    <Accordion.Body>
                        <LineChart serverData={data} />
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="3">
                    <Accordion.Header>Radar and Pie Charts</Accordion.Header>
                    <Accordion.Body>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
